...
#define PHY_SR \
  ((uint16_t)0x1F) /*!< PHY special control/ status register Offset     */

#define PHY_SPEED_STATUS \
  ((uint16_t)0x0004) /*!< PHY Speed mask                                  */
#define PHY_DUPLEX_STATUS \
  ((uint16_t)0x0010) /*!< PHY Duplex mask                                 */

#define PHY_ISFR \
  ((uint16_t)0x1D) /*!< PHY Interrupt Source Flag register Offset       */
#define PHY_ISFR_INT4 \
  ((uint16_t)0x0010) /*!< PHY Link down inturrupt                         */
