...
g_pfnVectors:
  ...
  /// @brief TIM1 Break and TIM9
  .word     TIM1_BRK_TIM9_IRQHandler
  /// @brief TIM1 Update and TIM10
  .word     TIM1_UP_TIM10_IRQHandler
  /// @brief TIM1 Trigger and Commutation and TIM11
  ...
  /// @brief TIM8 Break and TIM12
  .word     TIM8_BRK_TIM12_IRQHandler
  /// @brief TIM8 Update and TIM13
  .word     TIM8_UP_TIM13_IRQHandler
  /// @brief TIM8 Trigger and Commutation and TIM14
  ...
  /// @brief TIM6 and DAC1&2 underrun errors
  ...
  /// @brief USB OTG HS End Point 1 Out
  .word     OTG_HS_EP1_OUT_IRQHandler
  /// @brief USB OTG HS End Point 1 In
  ...
  /// @brief LTDC_IRQHandler
  .word     LTDC_IRQHandler
  /// @brief LTDC_ER_IRQHandler
